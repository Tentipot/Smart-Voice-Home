...
def main() -> None:
    ...
    print()
    print("=" * 72)
    print("CTC SAME-PROCESS GPU LIFECYCLE DIAGNOSTIC")
    print("=" * 72)
    print()
    print(
    ...
    print()
    print(
        "Loading CtcLanguageEvidenceProvider..."
    )
    print()
    ...
    print()
    print(
        f"Provider load time: "
        f"{load_seconds:.3f} s"
    )

    print()
    print(
        "Deleting provider and collecting "
        "Python objects..."
    )
    print()
    ...
    print(
        ...
        "VRAM while the CTC pair is resident."
    )
    print(
