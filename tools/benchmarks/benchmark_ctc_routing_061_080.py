...
def route_from_entropy_delta(
    ...
    """
    Frozen diagnostic rule defined before this corpus:
    ...
    No threshold is tuned from tests 061-080.
    """
...
def main() -> None:
    ...
    print("=" * 88)
    print(
        "CTC LANGUAGE ROUTING SECOND HOLD-OUT "
        "VALIDATION 061-080"
    )
    print("=" * 88)
    print()
    print(
        "Routing rule was frozen BEFORE this corpus:"
    )
    print(
    ...
    print(
        "All 20 samples are pure-language routing tests."
    )
    print()
    ...
    print("=" * 88)
    print(
        "CTC SECOND HOLD-OUT VALIDATION COMPLETE"
    )
    print("=" * 88)
    print()
