...
def main() -> None:
    ...
    print("=" * 80)
    print("HOLD-OUT VALIDATION: BG CTC vs EN CTC")
    print("TESTS 031-060")
    print("=" * 80)
    print()

    print(
        "IMPORTANT: This corpus must not be used "
        "to tune thresholds."
    )
    print()
    ...
    print()
    print("=" * 80)
    print("30-FILE HOLD-OUT VALIDATION")
    print("=" * 80)
    ...
    print(
        "Do NOT tune thresholds from these results."
    )
    print("=" * 80)
