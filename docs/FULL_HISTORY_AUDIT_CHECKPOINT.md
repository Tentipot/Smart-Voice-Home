...
Server. \## 4. Android historical evolution 4.1 Original Android-local
...
validation. \## 5. Historical Android CommandParser safety lessons 5.1
...
semantics. \## 6. Identity model A major historical finding is that
...
architecture. \## 7. Wake words and identity 7.1 Wake word is not
...
unresolved. \## 9. Multi-user / multi-device / multi-home 9.1 Multi-user
...
explicitly named home. \## 10. Authorization and security policy 10.1
...
verification. \## 12. Media architecture 12.1 Assistant Core must not
...
implementation design. \## 13. Credentials and secrets 13.1 Server
...
audited separately. \## 14. Remote access 14.1 Remote use is a
...
unless separately confirmed. \## 15. Privacy 15.1 Raw audio retention
...
implementation. \## 16. Assistant ON/OFF semantics Status: ACCEPTED
...
Android work. \## 17. STT --- current implemented route 17.1 Current
...
changes are authorized by this checkpoint. \## 18. CTC historical role
...
justification. \## 20. CTC + language model / beam decoding Status:
...
This is a priority continuation item. \## 22. MIXED speech 22.1 MIXED is
...
production route. \## 23. Related-language fallback Status: IMPLEMENTED
...
paired-CTC route. All call sites still need full audit. \## 24. Future
...
currently established as production implementation. \## 25. Selective
...
policy remains unresolved. \## 26. SttCandidate Status: DISCUSSED /
...
missing implementation. \## 27. STT validation evidence 27.1 Current
...
This remains unfinished. \## 28. AuroraCapture 28.1 Functional capture
...
during initial integration diagnostics. \## 29. Resource Manager 29.1
...
Exact policy thresholds remain open. \## 30. ModelManager is NOT the
...
belong to the future Resource Manager/Scheduler layer. \## 31.
...
release. Historical test output confirms these checks passed. \## 32.
...
manager decides otherwise. \## 33. ModelManager tests Status: EXECUTED /
...
merely stylistic abstraction. \## 35. Ownership correctness Status:
...
overlap incorrectly with cleanup of the old instance. \## 36. Resource
...
scripts and retained outputs still need to be cross-checked. \## 37. TTS
...
during the final audit. \## 39. Server API target Status: ACCEPTED
...
must not be described as implemented endpoints. \## 40. Deployment
...
later evidence says otherwise. \## 41. Important distinctions that MUST
...
reconstruction. \## 42. Known documentation inconsistencies / stale
...
either interpretation until the later history is fully read. \## 43.
...
project-memory documents? \## 44. Repository audit still required The
...
retained stdout/results and historical ChatLOG execution. \## 45.
...
separately in the reproducibility audit. \## 46. Audit methodology going
...
representative of the current model/configuration. \## 47. Current audit
...
audit is NOT complete. \## 48. Next audit continuation point Continue
...
rewritten/reconciled. \## 49. Safety rule for continuation Until the
...
explicit user approval. \## 50. Checkpoint conclusion The recovered
