...
from test_stt_service import TEST_AUDIO_PATH, make_evidence, make_service
...
class EvidenceResultTests(unittest.TestCase):
    ...
    def test_runner_uses_returned_evidence(self):
        from run_stt_validation import ROOT, run_case
        ...
        with patch('run_stt_validation.synchronize'), patch(
            'run_stt_validation.get_gpu_status', return_value={}
        ):
